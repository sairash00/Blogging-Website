...
const PostCard = ({ data }) => {
  ...
  return (
    <Link to={`/feeds/${data?._id}`} className='w-[45%] hover:border-[#4e71a5 ] rounded-md px-2 py-2 flex flex-col gap-3 justify-evenly max-md:w-full min-h-[30vh] border border-[#224271]'>
