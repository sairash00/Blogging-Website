  ...
  return (
    <div className=' w-full min-h-[50%] flex flex-wrap py-5  items-center justify-center gap-10 border-b border-[#224271] ' >
          ...
          <div className='flex flex-col gap-2' >
              <div className=' text-2xl flex gap-3 font-semibold ' >username </div>
              ...
              <button className=' px-2 py-1 bg-[whitesmoke] text-sm text-[#212121] rounded-md hover:bg-[#e2e2e2] ' >Follow</button>
          </div>
      </div>
  )
}
